...
int64 nChainStartTime = 1459234800;
...
const string strMessageMagic = "OfferlibationCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight == 1)
       nSubsidy = 400000000 * COIN; //Premin: 88M
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight < YEARLY_POS_BLOCK_COUNT * 4)            //1%
      nSubsidy /= 2;
    else
      nSubsidy = 0;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in OfferlibationCoin
    bool fStrictPayToScriptHash = true; // Always active in OfferlibationCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OfferlibationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "nothing to say.China's annual parliament meets under economic clouds. 2016-03-29";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x0336366864b6352bef87f72041db972f88a1ed7a898e84674a4a9aee8ede039e"));
...
unsigned char pchMessageStart[4] = { 0x14, 0x10, 0x03, 0x1D };
